...
//as funções a seguir terão testes de acordo com o tamanho do vetor iniciado, adicionando 1 a cada repetição
//do for, e testando se o resto de divisão é 0, sendo portanto um múltiplo
